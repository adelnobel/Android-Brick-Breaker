...
public class HighscoresActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TextView tv = (TextView) findViewById(getResources().getIdentifier(
				"nameHeader", "id", getPackageName()));
		tv.setTypeface(font);
		tv = (TextView) findViewById(getResources().getIdentifier("timeHeader",
				"id", getPackageName()));
		tv.setTypeface(font);
		...
		try {
			...
			for (String[] singleRow : resultsList) {
				TextView tv = (TextView) findViewById(getResources()
						.getIdentifier("name" + String.valueOf(x), "id",
								getPackageName()));
				tv.setText(singleRow[0]);
				tv.setTypeface(font);
				tv = (TextView) findViewById(getResources().getIdentifier(
						"time" + String.valueOf(x), "id", getPackageName()));
	...
	public Dialog onCreateDialog(int id) {
		...
		case ERROR_DIALOG:
			return new AlertDialog.Builder(this)
					...
					.setMessage(
							"An error occurred while retrieving scores, please check your connection")
