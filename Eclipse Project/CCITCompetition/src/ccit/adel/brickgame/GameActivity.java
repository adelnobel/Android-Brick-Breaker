...
public class GameActivity extends Activity {
	...
	protected Dialog onCreateDialog(int id) {
		...
		case SCORE_DIALOG:
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					case DialogInterface.BUTTON_POSITIVE:
						imm.toggleSoftInput(InputMethodManager.HIDE_NOT_ALWAYS,
								0);
						callScoreThread(name,
								(int) GameLoopThread.getElpasedTime() / 1000);
						break;
			...
			return new AlertDialog.Builder(this)
					.setPositiveButton("Publish", dialogClickListener)
					.setTitle("Upload your score").setIcon(R.drawable.share)
					.setNegativeButton("Cancel", dialogClickListener)
					.setCancelable(false).setView(input).show();

		case LOADING_DIALOG:
			View b = getLayoutInflater().inflate(R.layout.dialog, null);
			return new AlertDialog.Builder(this).setMessage("Loading")
					.setView(b).setCancelable(false).show();
		...
		case ERROR_DIALOG:
			return new AlertDialog.Builder(this)
					...
					.setMessage(
							"An error occurred while trying to upload your score, please check your connection")
					.setNegativeButton("Okay",
							new DialogInterface.OnClickListener() {
		...
		case PAUSED_DIALOG:
			...
			return new AlertDialog.Builder(this).setTitle("Paused")
					.setIcon(R.drawable.tick)
		...
		case WIN_DIALOG:
			...
			return new AlertDialog.Builder(this)
					...
					.setTitle("You Win!").setIcon(R.drawable.tick)
					.setMessage("Do you want to upload your score?")
