...
public class SendScore extends AsyncTask<Void, Void, Integer> {
	...
	public void uploadScore() throws Exception
	{
		...
		nameValuePairs.add(new BasicNameValuePair("name", java.net.URLEncoder.encode(name, "UTF-8")));  
		...
		InputStreamReader b = new InputStreamReader(en.getContent());
   ...
   {
	   try{uploadScore();}
	   catch(Exception e){fetchFailed = true;};
	   return 1;
   }
