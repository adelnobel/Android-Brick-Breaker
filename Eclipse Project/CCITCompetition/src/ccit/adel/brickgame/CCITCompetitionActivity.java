...
public class CCITCompetitionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new ImageView.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent game = new Intent(CCITCompetitionActivity.this, GameActivity.class);
        ...
        imageView2.setOnClickListener(new ImageView.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent highscores = new Intent(CCITCompetitionActivity.this, HighscoresActivity.class);
    ...
    private void initAnimations()
    {
        ...
        for(String img : adel)
        {
	        ImageView logoIV = (ImageView) findViewById(getResources().getIdentifier(img, "id", this.getPackageName()));
	        Animation logoMoveAnimation = AnimationUtils.loadAnimation(this, getResources().getIdentifier(img, "anim", this.getPackageName())); 
